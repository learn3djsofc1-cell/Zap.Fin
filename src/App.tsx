                ...
                <div className="flex justify-between items-center">
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 rounded-full bg-[#E50914] flex items-center justify-center">
                      <svg viewBox="0 0 24 24" fill="white" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4">
                        <path d="M17.3 14.3H15.9L8.7 5.1H10.1L17.3 14.3ZM12.7 14.3H11.3L15.9 8.3H17.3L12.7 14.3ZM6.7 14.3H5.3L12.7 5.1H14.1L6.7 14.3Z"/>
                      </svg>
                    </div>
                    <div>
                  ...
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 rounded-full bg-[#2775CA] flex items-center justify-center">
                      <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 text-white">
                        ...
                        <path d="M12 7V17M9 9H15M9 15H15" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                      </svg>
                    </div>
                    <div>
    ...
    <section id="features" className="bg-black py-24 lg:py-32">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-12 sm:mb-16">
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-400 mb-4">Key Features</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-[#1C1A1E] rounded-[32px] p-8 flex flex-col lg:row-span-2 relative overflow-hidden border border-white/5">
            <div className="w-16 h-16 bg-[#E867A4] rounded-2xl flex items-center justify-center mb-8">
            ...
            <div className="bg-[#141315] rounded-[24px] p-6 mt-auto border border-white/5">
              ...
              {/* Fade out bottom */}
              <div className="absolute bottom-0 left-0 right-0 h-24 bg-gradient-to-t from-[#1C1A1E] to-transparent pointer-events-none"></div>
            </div>
          </div>

          {/* Auditable Receipts */}
          <div className="bg-[#1C1A1E] rounded-[32px] p-8 border border-white/5">
            <div className="w-16 h-16 bg-[#E86782] rounded-2xl flex items-center justify-center mb-8">
              <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* Developer APIs */}
          <div className="bg-[#1C1A1E] rounded-[32px] p-8 border border-white/5">
            <div className="w-16 h-16 bg-[#9353D3] rounded-2xl flex items-center justify-center mb-8">
              <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="bg-[#2A2E1A] rounded-[32px] p-8 lg:col-span-2 flex flex-col md:flex-row gap-8 border border-white/5 overflow-hidden">
            <div className="flex-1">
              <div className="w-16 h-16 bg-[#84CC16] rounded-2xl flex items-center justify-center mb-8">
            ...
            <div className="flex-1 flex flex-col gap-4 justify-center items-center">
              <div className="w-full max-w-sm bg-[#1A1C10] rounded-2xl p-6 border border-[#84CC16]/20 shadow-[0_0_30px_rgba(132,204,22,0.1)]">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center bg-[#2A2E1A] p-3 rounded-xl">
                    <span className="text-gray-300 text-sm">Device Sessions</span>
                    <span className="text-[#84CC16] text-sm font-bold">Active (1)</span>
                  </div>
                  <div className="flex justify-between items-center bg-[#2A2E1A] p-3 rounded-xl">
                    <span className="text-gray-300 text-sm">KYC Status</span>
                    <span className="text-[#84CC16] text-sm font-bold">Verified</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          {/* Global Spending */}
          <div className="bg-[#1C1A1E] rounded-[32px] p-8 lg:col-span-2 flex flex-col md:flex-row items-center gap-8 border border-white/5 overflow-hidden">
            <div className="flex-1">
              <div className="w-16 h-16 bg-[#6366F1] rounded-2xl flex items-center justify-center mb-8">
                <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="bg-[#1C1A1E] rounded-[32px] p-8 border border-white/5">
            <div className="w-16 h-16 bg-[#F59E0B] rounded-2xl flex items-center justify-center mb-8">
              <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">

        ...
        <div className="py-12 grid grid-cols-2 sm:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <a href="#" className="text-gray-400 text-sm hover:text-white transition-colors">SDK Reference</a>
              <a href="#" className="text-gray-400 text-sm hover:text-white transition-colors">API Status</a>
              <a href="#" className="text-gray-400 text-sm hover:text-white transition-colors">Changelog</a>
            </div>
          </div>
          <div>
